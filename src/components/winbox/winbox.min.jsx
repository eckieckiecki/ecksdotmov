import "/src/components/winbox/winbox.min.css";
...
(function () {
  ...
  aa.innerHTML =
    "<div class=crt></div><div class=wb-header><div class=wb-control><span class=wb-min></span><span class=wb-max></span><span class=wb-full></span><span class=wb-close></span></div><div class=wb-drag><div class=wb-icon></div><div class=wb-title></div></div></div><div class=wb-body></div><div class=wb-n></div><div class=wb-s></div><div class=wb-w></div><div class=wb-e></div><div class=wb-nw></div><div class=wb-ne></div><div class=wb-se></div><div class=wb-sw></div></div>";
  function h(a, b, c, f) {
 ...
 self.max &&*/
  var u = [],
    x = [],
    ba = { capture: true, passive: false },
    l = { capture: true, passive: true },
    A,
    ea = 0,
    B = 10,
    E,
  ...
  function na() {
    ...
    for (var n, p; f < a; f++)
      (d = u[f]),
        ...
        d
          .resize((p + 1) | 0, d.h, true)
          .move((d.left + b[n] * p) | 0, K - d.bottom - d.h, true),
        b[n]++;
  }
  function V(a, b) {
    function c(g) {
  ...
  e.hide = function (a) {
    ...
    if (!this.hidden)
      return (
        this.onhide && this.onhide(), (this.hidden = true), this.addClass("hide")
      );
  };
  e.show = function (a) {
  ...
  e.maximize = function (a) {
    ...
    this.max ||
      (this.addClass("max")
        .resize(J - this.left - this.right, K - this.top - this.bottom, true)
