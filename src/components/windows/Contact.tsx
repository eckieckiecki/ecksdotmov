    ...
    <div className="contact-me" style={{ color: 'black', fontSize: 20, overflow: 'hidden', marginLeft: 12, marginRight: 12, marginTop: 12, paddingBottom: 4, fontFamily: 'Sans Nouveaux', textRendering: 'optimizeLegibility'}}>
      <span style={{fontSize:14, marginTop: 16, marginBottom: 8}}>Email:</span>
        ...
        <span style={{fontSize:14, marginTop: 16}}>Socials:</span>
            <div className="socials" style={{marginBottom: 32, alignContent: 'center', textAlign: 'center',display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gridTemplateRows: 'repeat(2, auto)', listStyleType: 'disc', margin: '8px auto', lineHeight: 1, fontSize: 14, border: '2px solid #222'}}>
