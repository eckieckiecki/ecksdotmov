    ...
    <div style={{ color: 'black', fontSize: 20, overflow: 'hidden', marginLeft: 12, marginRight: 12, marginTop: 12, paddingBottom: 4, fontFamily: 'Sans Nouveaux', textRendering: 'optimizeLegibility'}}>
      <span style={{fontSize:14, marginTop: 16, marginBottom: 8}}>Email:</span>
        ...
        <span style={{fontSize:14, marginTop: 16}}>Socials:</span>
            ...
            <span className='icon'><a href='https://instagram.com/ecksposting' target="_blank"><img src={icons.instagram} alt="YouTube" style={{ width: 48, height: 48}} /></a></span>
            <span className='icon'><a href='https://twitter.com/ecksposting' target="_blank"><img src={icons.xitter} alt="YouTube" style={{ width: 48, height: 48}} /></a></span>
            <span className='icon'><a href='https://steamcommunity.com/ecksposting' target="_blank"><img src={icons.steam} alt="YouTube" style={{ width: 48, height: 48}} /></a></span>
            <span className='icon'><a href='https://eckslol.newgrounds.com' target="_blank"><img src={icons.newgrounds} alt="YouTube" style={{ width: 48, height: 48}} /></a></span>
            </div>

            <span className="bottom-tag" style={{marginTop: 32}} >- preciate it boss -</span>
    </div>
  );
};
