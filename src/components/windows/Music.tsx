...
const Music = () => {
  return (
    <>
      <div className='notepad' style={{ color: 'black',fontSize: 8, fontFamily: 'Sans Nouveaux', overflow: 'hidden', paddingLeft: 16, paddingRight: 16, textRendering: 'optimizeLegibility', lineHeight: 1.3}}>
        ...
        <p style={{ fontSize: 8, lineHeight: 1.5}}>
